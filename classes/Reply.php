...
class Reply extends Comment {
  ...
  public function createReply() {
    $sql = "INSERT INTO comment (comment_content, user_id, post_id, comment_id) VALUES (?,?,?,?)";
    $stmt = $this->conn->prepare($sql);
    $stmt->bind_param("siiii", $this->comment_text, $_SESSION['user_id'], $this->comment_post_id, $this->reply_to_comment_id);
    $stmt->execute();
